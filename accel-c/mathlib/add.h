...
extern "C" {
    ...
    // 2. addend_length > 0
    inline uint8_t MATH_AddCarry(uintr_t* __restrict summand, size_t summand_length,
    ...
    inline uint8_t MATH_AddCarryTo(const uintr_t* summand, size_t summand_length,
