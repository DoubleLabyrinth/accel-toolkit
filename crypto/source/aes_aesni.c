...
void accelc_AES192_encrypt_aesni(uint8_t srcBytes[AES_BLOCK_SIZE], const AES192_KEY* srcKey) {
    ...
    buffer = _mm_aesenc_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 8));
    buffer = _mm_aesenc_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 9));
    buffer = _mm_aesenc_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 10));
    buffer = _mm_aesenc_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 11));
    buffer = _mm_aesenclast_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 12));
...
void accelc_AES192_decrypt_aesni(uint8_t srcBytes[AES_BLOCK_SIZE], const AES192_KEY* srcKey) {
    ...
    buffer = _mm_xor_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 12));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 11)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 10)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 9)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 8)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 7)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 6)));
...
void accelc_AES192_decrypt_aesni_fast(uint8_t srcBytes[AES_BLOCK_SIZE], const AES192_KEY* srcInverseKey) {
    ...
    buffer = _mm_aesdec_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 8));
    buffer = _mm_aesdec_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 9));
    buffer = _mm_aesdec_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 10));
    buffer = _mm_aesdec_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 11));
    buffer = _mm_aesdeclast_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 12));
...
void accelc_AES192_set_invkey_aesni(const AES192_KEY* __restrict srcKey, AES192_KEY* __restrict dstInverseKey) {
    _mm_storeu_si128((__m128i*)(dstInverseKey), _mm_loadu_si128((const __m128i*)(srcKey) + 12));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 1, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 11)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 2, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 10)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 3, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 9)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 4, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 8)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 5, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 7)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 6, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 6)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 7, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 5)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 8, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 4)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 9, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 3)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 10, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 2)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 11, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 1)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 12, _mm_loadu_si128((const __m128i*)(srcKey)));
}
...
void accelc_AES256_encrypt_aesni(uint8_t srcBytes[AES_BLOCK_SIZE], const AES256_KEY* srcKey) {
    ...
    buffer = _mm_aesenc_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 10));
    buffer = _mm_aesenc_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 11));
    buffer = _mm_aesenc_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 12));
    buffer = _mm_aesenc_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 13));
    buffer = _mm_aesenclast_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 14));
...
void accelc_AES256_decrypt_aesni(uint8_t srcBytes[AES_BLOCK_SIZE], const AES256_KEY* srcKey) {
    ...
    buffer = _mm_xor_si128(buffer, _mm_loadu_si128((const __m128i*)(srcKey) + 14));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 13)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 12)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 11)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 10)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 9)));
    buffer = _mm_aesdec_si128(buffer, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 8)));
...
void accelc_AES256_decrypt_aesni_fast(uint8_t srcBytes[AES_BLOCK_SIZE], const AES256_KEY* srcInverseKey) {
    ...
    buffer = _mm_aesdec_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 10));
    buffer = _mm_aesdec_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 11));
    buffer = _mm_aesdec_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 12));
    buffer = _mm_aesdec_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 13));
    buffer = _mm_aesdeclast_si128(buffer, _mm_loadu_si128((const __m128i*)(srcInverseKey) + 14));
...
void accelc_AES256_set_key_aesni(const uint8_t srcUserKey[AES256_USERKEY_LENGTH], AES256_KEY* dstKey) {
    ...
    buffer_l = _mm_loadu_si128((const __m128i*)srcUserKey);
    buffer_h = _mm_loadu_si128((const __m128i*)srcUserKey + 1);
...
void accelc_AES256_set_invkey_aesni(const AES256_KEY* __restrict srcKey, AES256_KEY* __restrict dstInverseKey) {
    _mm_storeu_si128((__m128i*)(dstInverseKey), _mm_loadu_si128((const __m128i*)(srcKey) + 14));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 1, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 13)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 1, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 12)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 1, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 11)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 1, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 10)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 1, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 9)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 2, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 8)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 3, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 7)));
    _mm_storeu_si128((__m128i*)(dstInverseKey) + 4, _mm_aesimc_si128(_mm_loadu_si128((const __m128i*)(srcKey) + 6)));
